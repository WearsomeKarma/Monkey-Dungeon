...
namespace MonkeyDungeon.Prefabs.UI
{
    public class Button : GameObject
    {
        ...
        public Button(SceneLayer sceneLayer, Vector3 position, Vector2 size, Action buttonClickHandler, RenderUnit buttonVisual, string text = "") 
