...
namespace MonkeyDungeon.GameFeatures
{
    ...
    public class GameEntity_Controller
    {
        ...
        internal Combat_Action Get_CombatAction(Combat_GameState combat)
        {
            ...
            Combat_Action finishedAction = new Combat_Action(result);
