namespace MonkeyDungeon_Vanilla_Domain.GameFeatures.AttributeNames.Definitions
{
    public static class MD_VANILLA_PARTICLES
    {
        ...
        public static readonly GameEntity_Attribute_Name_Particle BANNANA_RANG = new GameEntity_Attribute_Name_Particle("Bannana_Rang");

        public static readonly GameEntity_Attribute_Name_Particle[] STRINGS = new GameEntity_Attribute_Name_Particle[]
        {
            CHAOS_BOLT,
            POOPY_FLING,
            BANNANA_RANG
