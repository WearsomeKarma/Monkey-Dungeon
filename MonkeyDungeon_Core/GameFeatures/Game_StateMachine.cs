...
namespace MonkeyDungeon_Core.GameFeatures
{
    public class Game_StateMachine
    {
        ...
        internal void Relay_Entity_Resource(GameEntity_ServerSide_Resource resource)
        {
            Server.Broadcast(
                new MMW_Update_Entity_Resource(
                    resource.Attached_Entity.GameEntity_ID,
        ...
        internal void Relay_Entity_Static_Resource(GameEntity_ServerSide_Resource resource)
        {
            Broadcast(
                new MMW_Update_Ability_Point(resource.Attached_Entity.GameEntity_ID, (int)resource.Value)
                );
        }
