...
{
    public class KnightClass : GameEntity_ServerSide
    {
        public static readonly string   CLASS_NAME                          =   "Knight";
        ...
        public KnightClass(string name, int level, GameEntity_ServerSide_Controller serverSideController)
            : base(
